      ...
      <div className="App">
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div id='leftPanel' className="d-md-none d-xs-none d-sm-none d-lg-block col-lg-2 pl-0">
            ...
            <div id='HomeRightPanel' className=" d-md-none d-xs-none d-sm-none d-lg-block col-lg-3 pr-0">
                <HomeRightPanel />
